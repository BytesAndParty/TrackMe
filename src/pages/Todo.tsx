    ...
    <>
      <div className="space-y-6 pb-56">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Klick auf ein Todo zum Bearbeiten. Per Drag and Drop kannst du die Reihenfolge aendern.</p>
        </div>
        ...
        <div className="space-y-2">
          {todos.length === 0 && (
            <div className="rounded-xl border border-dashed border-slate-300 dark:border-slate-700 bg-white/70 dark:bg-slate-900/60 px-4 py-10 text-center">
              <p className="text-sm text-slate-500 dark:text-slate-400">Noch keine Todos. Unten im Feld kannst du das erste erstellen.</p>
            </div>
          )}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {!linkedItem && todo.linkedItemId && (
                      <p className="mt-2 text-[11px] text-amber-600 dark:text-amber-400">
                        Verlinktes Item wurde nicht gefunden.
                      </p>
                    )}
                  </div>
